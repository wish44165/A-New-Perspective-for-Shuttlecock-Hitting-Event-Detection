...
csvPath = '/home/yuhsi/Badminton/src/TrackNetV2_pytorch/golfdb_G3_fold5_iter3000_val_test_hitter_vote_roundhead_vote_backhand_vote_ballheight_vote_LXY.csv'    ################################ 1. csvPath ################################
...
for i in range(len(df_landingx)):
    ...
    print('i, yoloImg[i] =', i, yoloImg[i])
    cv2.imwrite('/home/yuhsi/Badminton/src/yolov5/runs/detect/exp_draw/case' + str(CASE) + '/' + yoloImg[i], im)
        
    

df['LandingY'] = newY    ################################ 4. attribute ################################
...
df.to_csv('golfdb_G3_fold5_iter3000_val_test_hitter_vote_roundhead_vote_backhand_vote_ballheight_vote_LX_LY_case' + str(CASE) + '_HD.csv', index=False)    ################################ 5. csv-name ################################
