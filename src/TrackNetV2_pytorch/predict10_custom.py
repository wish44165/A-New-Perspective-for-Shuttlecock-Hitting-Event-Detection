...
parser.add_argument('--load_weight', type = str, default = 'TrackNet10_30.tar', help = 'input model weight for predict')
...
valPath = '/home/yuhsi/Badminton/data/part1/val/'
...
for i in range(len(valVideoPath)):
	videoName = valVideoPath[i]
	vn = valVideos[i]
	


	f = open('./output/' + vn[:-4]+'_predict.csv', 'w')
