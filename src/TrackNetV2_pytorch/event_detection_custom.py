...
denoise_rally_Path = '/home/yuhsi/Badminton/src/TrackNetV2_pytorch/10-10Gray/denoise/'    ################################ 1. folder-path ################################
...
for drf in denoise_rally_List:
    filename = denoise_rally_Path + drf
    ...
    with open('/home/yuhsi/Badminton/src/TrackNetV2_pytorch/10-10Gray/event/' + outputName[:-4]+'_event.csv','w', newline='') as csvfile1:    ################################ 2. save-path ################################
