...
def smooth(path):
    ...
    outputName = path.split('/')[-1]
    df.to_csv('/home/yuhsi/Badminton/src/TrackNetV2_pytorch/10-10Gray/denoise/' + outputName[:-4]+'_denoise.csv',index=False)    ################################ 10. ################################

if __name__ == '__main__':
    predictPath = '/home/yuhsi/Badminton/src/TrackNetV2_pytorch/10-10Gray/output/'    ################################ 9. ################################
