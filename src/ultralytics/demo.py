...
cap = cv2.VideoCapture('/home/yuhsi/Badminton/src/yolov5/00171.mp4')    ################################ 3. demo video path ################################
...
out = cv2.VideoWriter('00171_v8pose.mp4',fourcc, fps, (width, height),True)
...
for i in range(length):
    ...
    res = model(im, imgsz=1280, conf=0.5, max_det=2)
